...
>
> **Phase 3: Selection & Cold Start (In Development)**
>
...
**2. Facet-Seeded Item Generation System**

The foundation for creating assessment questions is complete:
...
- **Quality control filters** for reading level, diversity, trauma-sensitive language
...
**3. Facet-Seeded Generation & Verification (75% Complete)**
...
- Additional filters: reading level, word count, diversity (cosine similarity < 0.92), trauma screening
- Complete audit trail of generation attempts and verification scores

**Phase 3 - Selection (🔄 In Development - Q1 2026):**
- Will rank all verified questions by quality and select optimal set per facet
- Algorithms designed, implementation underway
- Expected completion: Q1 2026

**Current capability:** We can generate and verify questions from facet descriptions. What's missing is the final selection and calibration ("cold start") process to create the first operational item bank.
...
**Timeline:** Q2 2026, after expert consultation is complete.
...
**Phase 0: Protocol Design & Readiness (Current - Q4 2025)**
...
**Phase 1: Build & Conformance (Q4 2025 - Q1 2026)**

**What we're building:**
- Finish facet-seeded generation selection phase
...
**Phase 2: Pilot & First Bank (Q1 2026)**
...
**Funding need:** $75K-150K (participant recruitment and compensation, data collection infrastructure, statistical analysis)

---

**Phase 3: Validation & Transparency (Q2 2026, if pilot successful)**
...
**Decision gate:** Peer-reviewed publication accepted + **L3 opinion letter** issued confirming validation meets standards for deployment

**Deliverable:** Published validation study, public dataset, **L3 expert opinion letter**, scientific credibility

**Funding need:** $50K-75K (larger sample, longitudinal tracking, publication fees, dataset preparation)

---

**Phase 4: Public Beta & API (Q2-Q3 2026, if validation successful)**
...
**Impact on funding:** Larger sample = higher recruitment costs (already budgeted at $75K-150K)
